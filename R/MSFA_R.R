...
#' @import psych
#' @export
#' @references De Vito, R., Bellio, R., Parmigiani, G. and Trippa, L. (2018). Multi-study Factor Analysis.
...
#' @references De Vito, R., Bellio, R., Trippa, L. and Parmigiani, G. (2018). Multi-study Factor Analysis. Submitted manuscript.
...
#' @export
#' @import robust psych
#' @references De Vito, R., Bellio, R., Trippa, L. and Parmigiani, G. (2016). Multi-study Factor Analysis. Submitted manuscript.
#' @references Pison, G., Rousseeuw, P.J., Filzmoser, P. and Croux, C. (2003). Robust factor analysis. Journal
...
#'
#'
#' A data set used by De Vito et al. (2018) as an illustrative example.
#'
#' @examples
#' \dontrun{
